...
class ClockAdapter(private val clocksData: MutableList<ClockInitData>) :
    RecyclerView.Adapter<ItemClockViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemClockViewHolder =
        ItemClockViewHolder(
